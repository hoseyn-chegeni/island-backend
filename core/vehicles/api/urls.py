...
from .v1.views import VehicleList, VehicleDetail, VehicleImageDeleteAPIView, VehicleImageCreateAPIView, VehicleLocationDetailAPIView, VehicleLocationListCreateAPIView
